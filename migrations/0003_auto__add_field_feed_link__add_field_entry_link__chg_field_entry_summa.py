...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('reader_feed', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Entry.link'
        db.add_column('reader_entry', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Changing field 'Entry.summary'
        db.alter_column('reader_entry', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Entry.content'
        db.alter_column('reader_entry', 'content', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Feed.link'
        db.delete_column('reader_feed', 'link')

        # Deleting field 'Entry.link'
        db.delete_column('reader_entry', 'link')

        # Changing field 'Entry.summary'
        db.alter_column('reader_entry', 'summary', self.gf('django.db.models.fields.TextField')(default=''))
